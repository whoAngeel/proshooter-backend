...
class TargetImageModel(Base):
    ...
    exercise_id = Column(UUID(as_uuid=True), ForeignKey("practice_exercises.id"), nullable=False)
    ...
    # Relationships
    exercise = relationship("PracticeExerciseModel", back_populates="target_images")
    analyses = relationship("TargetAnalysisModel", back_populates="target_image", cascade="all, delete-orphan")
